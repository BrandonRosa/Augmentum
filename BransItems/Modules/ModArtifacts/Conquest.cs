...
namespace BransItems.Modules.Pickups.Items.Essences
{
    class Conquest : ArtifactBase<Conquest>
    {
        ...
        public override Sprite ArtifactIconDeselected => MainAssets.LoadAsset<Sprite>("Assets/Models/ArtifactOfConquest/ConquestDisabled.png");
        public override Sprite ArtifactIconSelected => MainAssets.LoadAsset<Sprite>("Assets/Models/ArtifactOfConquest/ConquestEnabled.png");
        ...
        public static void DropHighlanders(int dropCount, Transform dropPosition)
        {
            ...
            while (num3 < num)
            {
                ...
                PickupDropletController.CreatePickupDroplet(pickupIndex, dropPosition.position + Vector3.up * .4f, val);
                num3++;
                val = val2 * val;
            }
        }

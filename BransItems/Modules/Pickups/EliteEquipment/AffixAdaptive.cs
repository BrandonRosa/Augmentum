...
namespace Augmentum.Modules.Pickups.EliteEquipments
{
    class AffixAdaptive : EliteEquipmentBase<AffixAdaptive>
    {
       ...
       // public override Color EliteBuffColor { get => base.EliteBuffColor; set => base.EliteBuffColor = value; }
        ...
        {
            SelectedPreset = ConfigManager.ConfigOptionValue<PresetChoice>("Elite: " + EliteModifier, "Preset Choice", PresetChoice.Default, "Choose a preset configuration for the Adaptive Elite. Default is the new default behavior. OldBehavior is the old behavior. OldButT1_5 is the old behavior but uses the same tier as gilded elites. Custom allows you to manually adjust each setting.",true);
            tierChoice = ConvertTierChoiceToVan(ConfigManager.ConfigOptionValue<TierChoice>("Elite: " + EliteModifier, "Tier Choice", TierChoice.T1, "Choose the tier of the Adaptive Elite. Only used if Preset Choice is set to Custom.",true));
            _healthMult = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Health Multiplier", DefaultPresetConfig.Healthmult, "Multiplies the health of the elite by this amount. Only used if Preset Choice is set to Custom.");
            _damageMult = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Damage Multiplier", DefaultPresetConfig.Damagemult, "Multiplies the damage of the elite by this amount. Only used if Preset Choice is set to Custom.");
            CostMultiplierOfElite = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Cost Multiplier", DefaultPresetConfig.Costmultiplier, "Cost to spawn the elite is multiplied by this. Decrease to make the elite spawn more. Only used if Preset Choice is set to Custom. AND TierChoice is CustomTier");
            PreHitArmorAdd = ConfigManager.ConfigOptionValue<int>("Elite: " + EliteModifier, "Pre-Hit Armor Addition", DefaultPresetConfig.PreHitArmorAdd, "Amount of armor added when hit before the adaptive boost activates. Only used if Preset Choice is set to Custom.");
            CooldownReductionPreHit = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Cooldown Reduction Pre-Hit", DefaultPresetConfig.CooldownReductionPreHit, "Cooldown reduction multiplier applied when hit before the adaptive boost activates. Only used if Preset Choice is set to Custom.");
            CooldownReductionAfterHit = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Cooldown Reduction After Hit", DefaultPresetConfig.CooldownReductionAfterHit, "Cooldown reduction multiplier applied after the adaptive boost activates. Only used if Preset Choice is set to Custom.");
            AttackSpeedPreHit = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Attack Speed Pre-Hit", DefaultPresetConfig.AttackSpeedPreHit, "Attack speed bonus applied when hit before the adaptive boost activates. Only used if Preset Choice is set to Custom.");
            AttackSpeedAfterHit = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Attack Speed After Hit", DefaultPresetConfig.AttackSpeedAfterHit, "Attack speed bonus applied after the adaptive boost activates. Only used if Preset Choice is set to Custom.");
            MoveSpeedAfterHit = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Move Speed After Hit", DefaultPresetConfig.MoveSpeedAfterHit, "Movement speed bonus applied after the adaptive boost activates. Only used if Preset Choice is set to Custom.");
            MoveSpeedInvisible = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Move Speed Invisible", DefaultPresetConfig.MoveSpeedInvisible, "Movement speed multiplier applied when invisible. Only used if Preset Choice is set to Custom.");
            AdaptiveCooldownTimer = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Adaptive Cooldown Timer", DefaultPresetConfig.AdaptiveCooldownTimer, "Cooldown time in seconds before the adaptive boost can activate again. Only used if Preset Choice is set to Custom.");
            AdaptiveBoostTimer = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Adaptive Boost Timer", DefaultPresetConfig.AdaptiveBoostTimer, "Duration in seconds of the adaptive boost after being hit. Only used if Preset Choice is set to Custom.");
            StacksOfRepulsionArmorPerHealth = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Stacks Of Repulsion Armor Per Health", DefaultPresetConfig.StacksOfRepulsionArmorPerHealth, "Amount of armor gained per point of health for the repulsion effect. Only used if Preset Choice is set to Custom.");
            MinimumStacksofRepulsionArmor = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Minimum Stacks of Repulsion Armor", DefaultPresetConfig.MinimumStacksofRepulsionArmor, "Minimum stacks of repulsion armor gained. Only used if Preset Choice is set to Custom.");
            SafeGaurdPercent = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Safe Gaurd Percent", DefaultPresetConfig.SafeGaurdPercent, "Percentage of max combined health that is the maximum damage that can be taken in one attack. Only used if Preset Choice is set to Custom.");
            MaxStacksofRepulsionArmor = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Maximum Stacks of Repulsion Armor", DefaultPresetConfig.MinimumStacksofRepulsionArmor, "Maximum stacks of repulsion armor gained. Only used if Preset Choice is set to Custom.");
            DamageTakenModifierTimer = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Damage Taken Modifier Timer", DefaultPresetConfig.DamageTakenModifierTimer, "Duration in seconds of the damage taken modifier after being hit. Only used if Preset Choice is set to Custom.");
            InvisibleTimer = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Invisible Timer", DefaultPresetConfig.InvisibleTimer, "Duration in seconds of invisibility after being hit. Only used if Preset Choice is set to Custom.");
            LacerationCount = ConfigManager.ConfigOptionValue<int>("Elite: " + EliteModifier, "Laceration Count", DefaultPresetConfig.LacerationCount, "Amount of laceration applied on hit. Only used if Preset Choice is set to Custom.");
            LacerationDuration = ConfigManager.ConfigOptionValue<float>("Elite: " + EliteModifier, "Laceration Duration", DefaultPresetConfig.LacerationDuration, "Duration in seconds of laceration applied on hit. Only used if Preset Choice is set to Custom.");
            MaxLaceration = ConfigManager.ConfigOptionValue<int>("Elite: " + EliteModifier, "Max Laceration", DefaultPresetConfig.MaxLaceration, "Maximum stacks of laceration that can be applied. Only used if Preset Choice is set to Custom.");
            ProcIsChance = ConfigManager.ConfigOptionValue<bool>("Elite: " + EliteModifier, "Proc Is Chance", DefaultPresetConfig.ProcIsChance, "If true, the laceration proc is chance based. If false, it is guaranteed on hit. Only used if Preset Choice is set to Custom.");
            EnableInvisibility = ConfigManager.ConfigOptionValue<bool>("Elite: " + EliteModifier, "Enable Invisibility", DefaultPresetConfig.EnableInvisibility, "Enable Adaptive Elites to be invisible.");

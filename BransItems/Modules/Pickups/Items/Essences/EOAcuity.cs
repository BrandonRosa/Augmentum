...
namespace Augmentum.Modules.Pickups.Items.Essences
{
    class EOAcuity : ItemBase<EOAcuity>
    {
        ...
        public override string ItemFullDescriptionRaw =>
            @"Increase <style=cIsDamage>Critical Strike</style> chance by <style=cIsDamage>{0}% </style><style=cStack>(+{1}% per stack)</style>.";

        public override string ItemFullDescriptionFormatted =>
            string.Format(ItemFullDescriptionRaw, CritChanceGain, CritChanceGain);

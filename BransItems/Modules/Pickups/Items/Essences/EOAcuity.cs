...
namespace BransItems.Modules.Pickups.Items.Essences
{
    class EOAcuity : ItemBase
    {
        ...
        {
            CritChanceGain = config.Bind<float>("Item: " + ItemName, "Crit chance given to character", .04f, "How much crit chance should Essense of Acuity grant?").Value;

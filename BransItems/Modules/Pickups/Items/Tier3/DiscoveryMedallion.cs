...
namespace BransItems.Modules.Pickups.Items.Tier3
{
    class DiscoveryMedallion : ItemBase<DiscoveryMedallion>
    {
        ...
        public override string ItemFullDescription => $"On pickup, wish for 1 of {Choices} Red tier items. Future wishes will come with 1<style=cStack>(+{AdditionalChoices} per stack)</style> more choice.";

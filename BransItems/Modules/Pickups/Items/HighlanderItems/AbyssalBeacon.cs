...
namespace Augmentum.Modules.Pickups.Items.HighlanderItems
{
    class AbyssalBeacon : ItemBase<AbyssalBeacon>
    {
        ...
        public override GameObject ItemModel => CreateItemModel();
        public override Sprite ItemIcon => MainAssets.LoadAsset<Sprite>("Assets/Models/Prefavs/Item/Null Newt/VoidNewt2.png");
        ...
        private GameObject CreateItemModel()
        {
            ...
            TempItemModel.gameObject.transform.GetChild(0).GetComponent<MeshRenderer>().SetMaterial(mat);
            TempItemModel.gameObject.transform.localScale *= 1.5f;

            UnityEngine.Object.Destroy(TempItemModel.GetComponentInChildren<MeshCollider>());
            //TempItemModel.transform.rotation = Quaternion.Euler(0f, 180f, 0);

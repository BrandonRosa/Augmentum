...
namespace Augmentum.Modules.Pickups.Items.HighlanderItems
{
    class GoatLeg : ItemBase<GoatLeg>
    {
        ...
        {
            float itemCount = (float) GetCount(sender);
            args.moveSpeedMultAdd += MovementGain * .01f *itemCount;
            args.sprintSpeedAdd += SprintGain*.01f* itemCount;
            args.jumpPowerMultAdd += JumpPowerGain*.01f*itemCount;

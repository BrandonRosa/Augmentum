...
namespace BransItems.Modules.Pickups.Items.Tier2
{
    class MassiveMatroyshka : ItemBase<MassiveMatroyshka>
    {
        ...
        public override GameObject ItemModel => MainAssets.LoadAsset<GameObject>("Assets/Models/Matroyshka/Massive.prefab");
        public override Sprite ItemIcon => MainAssets.LoadAsset<Sprite>("Assets/Models/Matroyshka/MassiveIcon.png");
        ...
        public static Dictionary<CharacterBody, int> MassiveList = new Dictionary<CharacterBody, int>();
            ...
            if (self)
            {
                ...
                if (currentCount > 0)
                {
                    ...
                    if (MassiveList.TryGetValue(self, out prevCount))
                    {
                        ...
                        MassiveList.Add(self, currentCount);
                }
            }
        }
